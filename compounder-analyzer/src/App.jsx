    ...
    <div className="compound-layout" style={{display:"grid",gridTemplateColumns:"300px 1fr",gap:18}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:14}}>
        ...
        <Card s={{background:`${T.gold}07`,border:`1px solid ${T.goldDim}44`}}>
          ...
          {[
            {l:lang==="es"?"Solo Capital (sin interés)":{lang==="es"?"Solo capital (sin interés)":"Capital only (no interest)"},v:fmtCalc(last.contributed||0)},
            {l:lang==="es"?"Con interés compuesto 🏆":{lang==="es"?"Con interés compuesto 🏆":"With compound interest 🏆"},v:fmtCalc(last.balance||0),hi:true},
            {l:lang==="es"?"Generado solo por interés":{lang==="es"?"Generado solo por interés":"Generated by interest alone"},v:`+${fmtCalc(last.interest||0)}`,pos:true},
    ...
    <div style={{background:`linear-gradient(135deg,${T.accent},${T.card})`,border:`1px solid ${T.goldDim}44`,borderRadius:16,padding:"32px 28px",textAlign:"center"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,maxWidth:860,margin:"0 auto"}}>
        {[
          ...
          {icon:"🎯",title:{lang==="es"?"Analizar una Acción":"Analyze a Specific Stock"},desc:"Enter any ticker — NVDA, AAPL, COST — and get a quality score, moat analysis (La Fosa del Negocio), and Wall Street consensus.",cta:"Analyze a Stock →",tab:"score",color:T.gold},
          {icon:"📁",title:{lang==="es"?"Revisar Mi Portafolio":"Audit Your Portfolio"},desc:"Already invested? Upload your positions and our AI will tell you what to hold, buy more, or sell — with live prices.",cta:"Analyze Portfolio →",tab:"portfolio",color:T.green},
